...
//         super(props);
//         this.state = this.getDefaultState(props.propsToken, props.propsInstanceId);
//     }

//     getDefaultState = (stateToken: string | null, stateInstanceId) => {
//         return {
...
//         console.log("Вызов асинхронного задания");
...
//         const requestURL = `http://127.0.0.1:8887/System.json`;
