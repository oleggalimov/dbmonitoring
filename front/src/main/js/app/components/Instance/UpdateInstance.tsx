...
export default class UpdateInstance extends React.Component<{}, {
    loading: boolean, instanceID: string, messages: Array<JSX.Element> | null, errors: Array<JSX.Element> | null, instanceLoaded: boolean,
